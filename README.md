...
Una vez lo tiene descargado puede generar el .jar que será el archivo que podrá ejecutar, para eello introduzca `make jar`
...
Para poder generar el javadoc de todo el proyecto escriba `make javadoc` y aparecerá en el directorio(una carpeta) html

//como clonar el repo, instrucciones de make(jar y javadoc) y la ayuda del código
// ` para poner código ``` código en consola
